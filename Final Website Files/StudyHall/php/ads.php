<?php
	// call fruitget api
	$fruitDay = file_get_contents("http://localhost:8890/week3/fruitdb3/fruitget.php");
...
<body>
				<header class="w3-container w3-teal"><h1>Fruit DataBase</h1></header>
				</div><center>
Please enter a fruit name, color, and image url.</center>
					<?php
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-4" id="fruit-ad">
					...
					<center><img class="img-responsive" src="<?= $fruitDay->fruitimage; ?>"></center>
				</div>
					<div class="page-header">
						<h3>Fruit List</h3>
					</div>
